jQuery(document).ready(() => {
    ...
    $(document).delegate(".open-update-form", "click", function () {
        ...
        let title = $(this).parent().siblings('td[data-index="model"]').text();
        let mark = $(this).parent().siblings('td[data-index="mark"]').text();
        let sClass = $(this).parent().siblings('td[data-index="class"]').text();
    ...
    $("#mmc-add-form-submit").click(() => {
        let title = $('input[name="title"]').val();
        let mark = $('select[name="mark"]').val();
        let sClass = $('select[name="class"]').val();
        $.ajax({
            type: "POST",
    ...
    $(document).delegate("#mmc-update-form-submit", "click", function () {
        ...
        let mark = $('select[name="mark"]').val();
        let sClass = $('select[name="class"]').val();
        let id = $('input[name="mmc-form-id"]').val();
        $.ajax({
            type: "POST",
