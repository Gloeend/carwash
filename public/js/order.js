...
var OrderService = /*#__PURE__*/function () {
  ...
  _createClass(OrderService, [{
    ...
    value: function change(el) {
      var sIndex = $(el).attr("data-index");
      var listItem = $('.list-services__service-item[data-index="' + sIndex + '"]');
      ...
      listItem.addClass("d-flex").siblings('[data-index="' + this.index + '"]').removeClass("d-flex").addClass("d-none");
      this.index = sIndex;
      return true;
    }
  }, {
    key: "clickCart",
    value: function clickCart(el) {
      var sIndex = $(el).children("button").attr("data-index");
    ...
    key: "removeCart",
    value: function removeCart(el) {
      var sItem = $(el).children("div").children("p:first-child").text();
    ...
    value: function changePrice() {
      ...
      $(".list-services__end").children("p:last-child").children("span").html(this.sum + " ₽");
      return true;
    }
  }, {
    key: "changeCartLength",
    value: function changeCartLength() {
      $(".list-services__end").children("p:first-child").children("span").html(this.cart.length);
      return true;
    }
  }, {
    key: "setMark",
    value: function setMark(id) {
      this.mark = id;
      var result;
      $.ajax({
        type: "POST",
      ...
      for (var i = 0; i < result.length; ++i) {
        $("select[name=\"model\"]").append('<option value="' + result[i].id + '">' + result[i].title + "</option>");
      }
    }
  }, {
    key: "setModel",
    value: function setModel(id) {
      this.model = id;

      if (id !== 0) {
        console.log(id);
        this.setClass(id);
        $("#model-class-price").html('<p class="align-self-center mb-1 ml-2 w-100">Класс автомобиля -' + this["class"].title + ", стоимость - " + this["class"].price + "₽</span></p>");
      } else {
        this["class"] = {};
    ...
    key: "setClass",
    value: function setClass(id_model) {
      var result = {};
      $.ajax({
        type: "POST",
    ...
    value: function sendForm() {
      var phoneReplaceChars = ["(", ")", "-", " ", "+", "_"];
      var phone = $('input[name="phone"]').val();

      for (var i = 0; i < phoneReplaceChars.length; i++) {
      ...
      $.ajax({
        ...
        success: function success(response) {
          ...
          return $(".alert-success").removeClass("d-none").children("p").html("Спасибо за отправку заявки! Вам перезвонят в ближайшее время для уточнения даты");
        },
        statusCode: {
          422: function _(xhr, status, error) {
            ...
            for (var key in err.errors) {
              return $(".alert-danger").removeClass("d-none").children("p").html(err.errors[key][0]);
            }
          }
        }
      });
...
jQuery(document).ready(function () {
  ...
  $("form").children("button.button").click(function () {
    app.sendForm();
  });
});
})();
